  ...
  <div>
    ...
    <div class="md:flex md:flex-col md:h-screen">
      <div class="md:flex md:shrink-0">
        <div class="flex items-center justify-between px-6 py-3 bg-indigo-900 md:shrink-0 md:justify-center md:w-56">
          <Link class="mt-1" href="/">
            <logo class="fill-white" width="163" height="36" />
          </Link>
        ...
        <div class="md:text-md flex items-center justify-between p-4 w-full text-sm bg-white border-b md:px-12 md:py-0">
          <div class="mr-4 mt-1"><!-- Название предприятия --></div>
          <dropdown class="mt-1" placement="bottom-end">
            ...
            <template #dropdown>
              <div class="mt-2 py-2 text-sm bg-white rounded shadow-xl">
                ...
                <Link class="block px-6 py-2 hover:text-white hover:bg-indigo-500" href="/users">Пользователи</Link>
                <Link class="block px-6 py-2 w-full text-left hover:text-white hover:bg-indigo-500" href="/logout" method="delete" as="button">Выйти</Link>
              </div>
            </template>
          </dropdown>
        </div>
